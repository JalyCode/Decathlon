...
{
    public partial class FrmOriginalCLPDataHandle : Form
    {
        //private FrmMain frmParent;
        private OperateType opType;
        public FrmOriginalCLPDataHandle( )
        {
            InitializeComponent( );
        }
        ...
        public FrmOriginalCLPDataHandle(string strCaption,OperateType operateType,DataTable dt )
        {
            InitializeComponent( );
        ...
        private void FrmCLPDataInput_Shown( object sender , EventArgs e )
        {
            this.dataGridView1.CurrentCell = null;
        }
    }
