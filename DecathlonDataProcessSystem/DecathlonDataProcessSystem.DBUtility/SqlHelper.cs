...
namespace DecathlonDataProcessSystem.DBUtility
{
    /// <summary>
    /// 数据访问基础类(基于SQLServer)
    /// </summary>
    public abstract class SqlHelper
    {
        ...
        //public static readonly string LocalSqlServer = ConfigurationManager.AppSettings["LocalSqlServer"];
        public static readonly string LocalSqlServer = ConfigurationManager.ConnectionStrings["SqlServerConn"].ConnectionString;
        /// <summary>
        /// 通用分页存储过程
        /// </summary>
