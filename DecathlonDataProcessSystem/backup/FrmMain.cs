...
namespace DecathlonDataProcessSystem.App
{
    ...
    public partial class FrmMain : Form
    {
        ...
        private void SetSubForm( string className )
        {
            try
            {
                ...
                if ( t != null )
                {
                    ...
                    {
                        Form frm = (Form)Activator.CreateInstance( t , OriginalCLPTable );
                        ShowMdiChild( frm );
                    }

                    //if ( className.Equals( "DecathlonDataProcessSystem.App.FrmInput" ))
                    //{
                    //    Form frm = (Form)Activator.CreateInstance( t , new object[] { new UpdateMenu( GetModuleList ) } );
                    //    ShowMdiChild( frm );
                    //}
                    //else
                    //{
        ...
        private void btnOriginalCLPInput_Click( object sender , EventArgs e )
        {
            ...
            //double ss=Math.Round( 0.55555 , 2 );
            //double dbdata = 0.55555;
            //string str1 = dbdata.ToString( "f2 " );

            //string result = String.Format( "{0:N2} " , 0.55555 );//2位 
            //string result1 = String.Format( "{0:N3} " , 0.55555 );//3位 
            ...
            if ( fd.ShowDialog( ) == DialogResult.OK )
            {
                ...
                OriginalCLPTable=dt.Copy();
                //if ( !ExcuteDataInput( dt , fd.FileName , ref errMsg ) )
                //{
                //    MessageBox.Show( errMsg );
                //    return;
                //} 
                ...
                //dt.Columns["FileName"].DefaultValue=fd.FileName.Substring( fd.FileName.LastIndexOf( '\\' )+1 );
                //dt.Columns["CreateTime"].DefaultValue=DateTime.Now;
                //dt.Columns["Creator"].DefaultValue="admin";
                //dt.AcceptChanges( );
                bll.BulkOriginalCLPInsert( dt , 1000 );
        ...
        private void UnitDataTable( DataTable dt1 , DataTable dt2)
        {
            ...
            //    on clp.Field<String>( "MODEL CODE" ) equals basicdata.Field<String>( "ModelCode" ) into temp
            //    from tt in temp.DefaultIfEmpty( )
            //    select new 
            //    {
            //        ItemCode = clp.Field<String>( "ITEM CODE" ) ,
            //        ShippingNumber = clp.Field<String>( "SHIPPING NUMBER" ) ,
            //        OrderNumber = clp.Field<String>( "ORDER NUMBER" ) ,
            //        //OriginalPONumber = clp.Field<String>("OriginalPONumber"),
            //        PalletNumber = clp.Field<String>( "PALLET_NUMBER" ) ,
            //        ParcelNumber = clp.Field<String>( "PARCEL NUMBER" ) ,
            //        ModelCode = clp.Field<String>( "MODEL CODE" ) ,
            //        Origin = clp.Field<String>( "ORIGIN" ) ,
            //        Quantity = clp.Field<String>( "QUANTITY" ) ,
            //        QuantityUnit = clp.Field<String>( "QUANTITY UNIT" ) ,
            //        DispatchingKey = clp.Field<String>( "DISPATCHING KEY" ) ,
            //        EnglishComposition = clp.Field<String>( "English Composition" ) ,
            ...
            //        TypeOfGoods = clp.Field<String>( "TYPE OF GOODS" ) ,
            //        Price = clp.Field<String>( "PRICE" ) ,
            //        Currency = clp.Field<String>( "CURRENCY" ) ,
            //        //HSCode = clp.Field<String>("HSCode"),
            //        TotalValue = clp.Field<String>( "TOTAL VALUE" ) ,
            //        //Unit = clp.Field<String>("Unit"),
            //        NETWeight = clp.Field<String>( "NET WEIGHT" ) ,
            //        GrossWeight = clp.Field<String>( "GROSS WEIGHT" ) ,
            //        CommercialInvoiceNO = clp.Field<String>( "COMMERCIAL INVOICE NO" ) ,
            //        StoreNO = clp.Field<String>( "STORE NO" ) ,
            //        StoreName = clp.Field<String>( "STORE NAME" ) ,
            //    };
            var query1 =
                from clp in dt1.AsEnumerable( )
