...
{
    public partial class FrmMulSheet : Form
    {
        public FrmMulSheet( )
        {
            InitializeComponent( );
        }
        public FrmMulSheet( string strCaption , OperateType operateType , DataSet ds )
        {
            InitializeComponent( );
        ...
        private void FrmMulSheet_Shown( object sender , EventArgs e )
        {
            this.dataGridView1.CurrentCell = null;
            this.dataGridView2.CurrentCell = null;
        }
